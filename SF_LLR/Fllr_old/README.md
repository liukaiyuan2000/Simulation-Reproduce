...
install.packages("https://bitbucket.org/StanislavNagy/fllr/raw/ * key * /fllr_0.0.2.tar.gz",type="source")
library(fllr)
help(package=fllr)
help(fllr)
```
...
install.packages("fllr_0.0.2.tar.gz", repos = NULL, type="source")
```
